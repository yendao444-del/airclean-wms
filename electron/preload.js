...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    returns: {
        ...
        updateWorkflow: (id, field, value) => ipcRenderer.invoke('returns:updateWorkflow', { id, field, value }),
    ...
    refunds: {
        ...
        updateStatus: (id, status) => ipcRenderer.invoke('refunds:updateStatus', { id, status }),
